<template>
    <h2 class="cards__title">Для путешествий</h2>
    <p class="cards__description">Данные тесты отлично подходят для тех, кто только начал изучать английский язык (уровни A0,A1,A2)</p>
